...
Moved to the `api-conventions` capability spec: `openspec/specs/api-conventions/spec.md`.
...
Moved to the `development-workflow` capability spec: `openspec/specs/development-workflow/spec.md`.
