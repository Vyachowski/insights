...
const csvWriter = createObjectCsvWriter({
  ...
  header: [
    ...
    {
      id: "visit_duration_yandex_in_sec",
      title: "visit_duration_yandex_in_sec",
    },
    {
      id: "visit_duration_google_in_sec",
      title: "visit_duration_google_in_sec",
    },
...
export async function writeMetricsToCsv(siteId: number, metrics: MetricRow[]) {
  ...
  console.log(
    `✅ Metrics for site ${siteId} written to CSV (${metrics.length} rows)`,
  );
}
