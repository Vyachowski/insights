...
export const SiteMetricFindFirstSelectSchema: z.ZodType<Prisma.SiteMetricSelect> = z.object({
...
export const SiteMetricFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    siteId: z.boolean().optional(),
    date: z.boolean().optional(),
    yandexUsers: z.boolean().optional(),
...
export const SiteMetricFindFirstSchema: z.ZodType<Prisma.SiteMetricFindFirstArgs> = z.object({ select: SiteMetricFindFirstSelectSchema.optional(), include: z.lazy(() => SiteMetricIncludeObjectSchema.optional()), orderBy: z.union([SiteMetricOrderByWithRelationInputObjectSchema, SiteMetricOrderByWithRelationInputObjectSchema.array()]).optional(), where: SiteMetricWhereInputObjectSchema.optional(), cursor: SiteMetricWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SiteMetricScalarFieldEnumSchema, SiteMetricScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SiteMetricFindFirstArgs>;

export const SiteMetricFindFirstZodSchema = z.object({ select: SiteMetricFindFirstSelectSchema.optional(), include: z.lazy(() => SiteMetricIncludeObjectSchema.optional()), orderBy: z.union([SiteMetricOrderByWithRelationInputObjectSchema, SiteMetricOrderByWithRelationInputObjectSchema.array()]).optional(), where: SiteMetricWhereInputObjectSchema.optional(), cursor: SiteMetricWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SiteMetricScalarFieldEnumSchema, SiteMetricScalarFieldEnumSchema.array()]).optional() }).strict();