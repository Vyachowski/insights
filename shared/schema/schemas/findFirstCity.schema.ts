...
export const CityFindFirstSelectSchema: z.ZodType<Prisma.CitySelect> = z.object({
...
export const CityFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    slug: z.boolean().optional(),
    name: z.boolean().optional(),
