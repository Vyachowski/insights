...
export const SiteFindFirstSelectSchema: z.ZodType<Prisma.SiteSelect> = z.object({
    id: z.boolean().optional(),
    cityId: z.boolean().optional(),
    name: z.boolean().optional(),
    group: z.boolean().optional(),
    url: z.boolean().optional(),
    yandexCounterId: z.boolean().optional(),
    googleCounterId: z.boolean().optional(),
    yandexTagManagerId: z.boolean().optional(),
    googleTagManagerId: z.boolean().optional(),
...
export const SiteFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cityId: z.boolean().optional(),
    name: z.boolean().optional(),
    group: z.boolean().optional(),
...
export const SiteFindFirstSchema: z.ZodType<Prisma.SiteFindFirstArgs> = z.object({ select: SiteFindFirstSelectSchema.optional(), include: z.lazy(() => SiteIncludeObjectSchema.optional()), orderBy: z.union([SiteOrderByWithRelationInputObjectSchema, SiteOrderByWithRelationInputObjectSchema.array()]).optional(), where: SiteWhereInputObjectSchema.optional(), cursor: SiteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SiteScalarFieldEnumSchema, SiteScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SiteFindFirstArgs>;

export const SiteFindFirstZodSchema = z.object({ select: SiteFindFirstSelectSchema.optional(), include: z.lazy(() => SiteIncludeObjectSchema.optional()), orderBy: z.union([SiteOrderByWithRelationInputObjectSchema, SiteOrderByWithRelationInputObjectSchema.array()]).optional(), where: SiteWhereInputObjectSchema.optional(), cursor: SiteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SiteScalarFieldEnumSchema, SiteScalarFieldEnumSchema.array()]).optional() }).strict();