...
export const CallImportFindFirstSelectSchema: z.ZodType<Prisma.CallImportSelect> = z.object({
...
export const CallImportFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    site_id: z.boolean().optional(),
    date: z.boolean().optional(),
    src: z.boolean().optional(),
...
export const CallImportFindFirstSchema: z.ZodType<Prisma.CallImportFindFirstArgs> = z.object({ select: CallImportFindFirstSelectSchema.optional(), include: z.lazy(() => CallImportIncludeObjectSchema.optional()), orderBy: z.union([CallImportOrderByWithRelationInputObjectSchema, CallImportOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallImportWhereInputObjectSchema.optional(), cursor: CallImportWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallImportScalarFieldEnumSchema, CallImportScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CallImportFindFirstArgs>;

export const CallImportFindFirstZodSchema = z.object({ select: CallImportFindFirstSelectSchema.optional(), include: z.lazy(() => CallImportIncludeObjectSchema.optional()), orderBy: z.union([CallImportOrderByWithRelationInputObjectSchema, CallImportOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallImportWhereInputObjectSchema.optional(), cursor: CallImportWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallImportScalarFieldEnumSchema, CallImportScalarFieldEnumSchema.array()]).optional() }).strict();