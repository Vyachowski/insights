...
const sitemetricwhereinputSchema = z.object({
  ...
  visit_duration_yandex_in_sec: z.union([z.lazy(() => FloatFilterObjectSchema), z.number()]).optional(),
  visit_duration_google_in_sec: z.union([z.lazy(() => FloatFilterObjectSchema), z.number()]).optional(),
  visit_duration_other_in_sec: z.union([z.lazy(() => FloatFilterObjectSchema), z.number()]).optional(),
