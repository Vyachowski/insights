...
const makeSchema = () => z.object({
  ...
  visit_duration_yandex_in_sec: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  visit_duration_google_in_sec: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  visit_duration_other_in_sec: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const SiteMetricUncheckedUpdateManyInputObjectSchema: z.ZodType<Prisma.SiteMetricUncheckedUpdateManyInput> = makeSchema() as unknown as z.ZodType<Prisma.SiteMetricUncheckedUpdateManyInput>;
export const SiteMetricUncheckedUpdateManyInputObjectZodSchema = makeSchema();
