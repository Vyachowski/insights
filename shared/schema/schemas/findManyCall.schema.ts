...
export const CallFindManySelectSchema: z.ZodType<Prisma.CallSelect> = z.object({
...
export const CallFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    site_id: z.boolean().optional(),
    gudok_id: z.boolean().optional(),
    project_id: z.boolean().optional(),
