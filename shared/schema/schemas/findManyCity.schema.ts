...
export const CityFindManySelectSchema: z.ZodType<Prisma.CitySelect> = z.object({
...
export const CityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    slug: z.boolean().optional(),
    name: z.boolean().optional(),
