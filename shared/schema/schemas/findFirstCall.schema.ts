...
export const CallFindFirstSelectSchema: z.ZodType<Prisma.CallSelect> = z.object({
...
export const CallFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    siteId: z.boolean().optional(),
    gudokId: z.boolean().optional(),
    projectId: z.boolean().optional(),
...
export const CallFindFirstSchema: z.ZodType<Prisma.CallFindFirstArgs> = z.object({ select: CallFindFirstSelectSchema.optional(), include: z.lazy(() => CallIncludeObjectSchema.optional()), orderBy: z.union([CallOrderByWithRelationInputObjectSchema, CallOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallWhereInputObjectSchema.optional(), cursor: CallWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallScalarFieldEnumSchema, CallScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CallFindFirstArgs>;

export const CallFindFirstZodSchema = z.object({ select: CallFindFirstSelectSchema.optional(), include: z.lazy(() => CallIncludeObjectSchema.optional()), orderBy: z.union([CallOrderByWithRelationInputObjectSchema, CallOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallWhereInputObjectSchema.optional(), cursor: CallWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallScalarFieldEnumSchema, CallScalarFieldEnumSchema.array()]).optional() }).strict();