...
- Deps: −~28 packages (Nest/Prisma/passport/class-validator/Swagger/axios/Redux), +react-router/@react-router/node, drizzle-orm/drizzle-kit/drizzle-zod, pg (argon2 and zod stay; no auth library).
