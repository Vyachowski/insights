# dashboard-expenses-by-category Specification

## Purpose
A dashboard widget that shows where money goes: the current month's expense total per category (`expenses.type`), aggregated server-side in the dashboard loader and rendered largest-first in rubles.
