...
## Purpose
How the React frontend is layered: one-directional data flow (api → thunks → slices → selectors), selectors-mandatory reads, components-dispatch-never-fetch, the container/view split, and auth-guarded routing.
