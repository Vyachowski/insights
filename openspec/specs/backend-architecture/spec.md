...
## Purpose
How the NestJS backend is organized: self-contained domain modules, cross-cutting concerns in `common/` (guards, decorators, interceptors, filters), and centralized database (`PrismaService`) and config access.
