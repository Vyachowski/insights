...
## Purpose
The top-level page structure of the authenticated app: which sidebar entries exist, their routes, and which data tables each page groups. Finances, traffic signals, and portfolio reference data live on separate pages rather than behind one combined «Данные» tab.
